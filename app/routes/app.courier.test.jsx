...
export async function loader({ request }) {
  ...
  const pathaoCreds = await prisma.shopCourierCredentials.findUnique({
    where: {
  ...
  const steadfastCreds = await prisma.shopCourierCredentials.findUnique({
    where: {
      shopDomain_courierServiceId: {
        shopDomain,
  ...
  return new Response(JSON.stringify({ decrypted, shopDomain }), {
