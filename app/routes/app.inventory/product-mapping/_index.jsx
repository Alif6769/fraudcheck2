...
export async function loader({ request }) {
  // optional: authenticate here if needed
...
/* =========================
   ACTION – handles product deletion & product sync
========================= */
...
function renderRootProduct(product, products) {
  ...
  return (
    <s-link href={`/app/inventory/product-mapping/${root.id}`}>
      {root.productName}
    </s-link>
  );
}
...
========================= */
export default function ProductMappingIndex() {
  ...
  const currentAction =
    fetcher.submission?.formData?.get("actionType") || null;
